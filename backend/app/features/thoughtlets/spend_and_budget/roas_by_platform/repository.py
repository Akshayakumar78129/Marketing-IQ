"""
Thoughtlets Spend and Budget - ROAS by Platform repository - Data access layer.
"""
...
class ROASByPlatformRepository:
    ...
    def get_roas_by_platform(
        ...
        """
        Fetch ROAS breakdown by platform.
        ...
        Returns:
            List of dictionaries with platform and ROAS data
        """
        date_conditions = []
        params = {}
