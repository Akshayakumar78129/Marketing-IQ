...
create or replace transient table CLIENT_RARE_SEEDS_DB.PUBLIC_analytics.dim_segment
...
select
    md5(cast(coalesce(cast(s.segment_id as TEXT), '_dbt_utils_surrogate_key_null_') as TEXT)) as segment_sk,
    'klaviyo' as platform,
    s.segment_id,
    s.segment_name,
    s.definition,
