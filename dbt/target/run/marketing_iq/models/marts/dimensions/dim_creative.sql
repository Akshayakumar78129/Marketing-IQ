...
create or replace transient table CLIENT_RARE_SEEDS_DB.PUBLIC_analytics.dim_creative
...
with creatives as (
    ...
    from CLIENT_RARE_SEEDS_DB.META_ADS.creative_history
)

select
    md5(cast(coalesce(cast(creative_id as TEXT), '_dbt_utils_surrogate_key_null_') as TEXT)) as creative_sk,
    'meta' as platform,
    creative_id,
    account_id,
    creative_name,
