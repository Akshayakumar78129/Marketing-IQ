...
create or replace transient table CLIENT_RARE_SEEDS_DB.PUBLIC_analytics.dim_conversion_action
...
with ga4_conversion_events_raw as (
    ...
    from CLIENT_RARE_SEEDS_DB.GA4.conversion_events
),
...
select
    md5(cast(coalesce(cast(event_name as TEXT), '_dbt_utils_surrogate_key_null_') as TEXT)) as conversion_action_sk,
    'ga4' as platform,
