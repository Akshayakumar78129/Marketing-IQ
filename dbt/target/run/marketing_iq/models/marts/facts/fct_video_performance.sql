...
create or replace transient table CLIENT_RARE_SEEDS_DB.PUBLIC_analytics.fct_video_performance
...
select
    md5(cast(coalesce(cast(video_id as TEXT), '_dbt_utils_surrogate_key_null_') as TEXT)) as video_performance_sk,
    'meta' as platform,
    video_id,
    account_id,
    video_title,
